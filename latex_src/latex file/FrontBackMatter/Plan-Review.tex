...
\hline
\textbf{№} & \makebox[9.5cm][c]{\textbf{Ажлын бүлэг, хэсгийн нэр}} & \textbf{Эзлэх хувь} & \textbf{Дуусах хугацаа} \\ \hline
...
\newline $\bullet$ Судалгааны цоорхойн дүн шинжилгээ & 10\% & . . . . . . . . . . . \\ \hline
3 & \textbf{Бүлэг 3: Аргазүй ба архитектур}
\newline $\bullet$ Судалгааны загвар, хоёр шатлалт ангиллын аргачлал
\newline $\bullet$ MN-BERT fine-tuning стратеги
\newline $\bullet$ Baseline загваруудын (LR, NB, SVM) тохиргоо
...
\newline $\bullet$ news.mn болон Facebook эх сурвалжаас өгөгдөл цуглуулалт
\newline $\bullet$ Кирилл шүүлтүүр, preprocessing pipeline
...
5 & \textbf{Бүлэг 5: Загвар хөгжүүлэлт ба Pipeline}
\newline $\bullet$ MN-BERT архитектурын дэлгэрэнгүй тайлбар
\newline $\bullet$ Stage 1, Stage 2 training pipeline
\newline $\bullet$ Гиперпараметрийн оновчлол
\newline $\bullet$ SMOTE ангиллын тэнцвэржүүлэлт
...
\newline $\bullet$ Baseline-тай харьцуулсан дүгнэлт
...
\newline $\bullet$ Annotation-ы ёс зүй, Cohen's Kappa
