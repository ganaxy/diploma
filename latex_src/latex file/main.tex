...
\usetikzlibrary{shapes,arrows,automata,positioning,shadows,shapes.geometric}
...
\thesistitle{Монгол хэлний цахим орчин дах хандлагыг тодорхойлох, шүүх хиймэл оюунд суурилсан NLP систем}
...
%-------------------------------------------------------------------------------
\include{Chapters/introduction}   % Удиртгал (БҮЛЭГ 1)
...
\include{Chapters/Chapter5}   % БҮЛЭГ 5: Загвар хөгжүүлэлт ба Pipeline
