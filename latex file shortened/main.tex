...
\usepackage{cmap} % PDF-д кирилл тэмдэгтийн хайлт/хуулбар зөв ажиллахад хэрэгтэй
...
\thesistitle{Монгол хэлний цахим орчин дахь хандлагыг тодорхойлох NLP системийн хөгжүүлэлт}
    \thesistype{БАКАЛАВРЫН ДИПЛОМЫН АЖИЛ}
\supervisor{Доктор (Ph.D) Н.Анхбаяр} % Удирдагч
 \reader{Магистр (M.Sc) Б.Цэрэнлхам}
\advisor{Магистр (M.Sc) Э.Батцэцэг} % Зөвлөгч
\degreeind{061902000000002306}
\degree{Хиймэл оюун}
\authorshort{Г.Ган-Од} % Товч нэр
\authorlong{Ганболд Ган-Од} % Бүтэн нэр
\addresses{ganboldganod634@gmail.com}
\subject{Хиймэл оюун}
\keywords{Монгол хэлний текст шинжилгээ, хортой агуулгын автомат ангилал, бүтээлч шүүмжлэл, урьдчилан сургагдсан хэлний загвар}
...
\group{Эх хэлний боловсруулалтын судалгааны баг}
...
% Зөвхөн бүлэг (X) ба хэсэг (X.Y) дугаарлагдана — дэд хэсэг (X.Y.Z) дугааргүй
\setcounter{secnumdepth}{1}
% Гарчигт зөвхөн бүлэг ба хэсэг харагдана
...
\include{Chapters/Chapter1}   % БҮЛЭГ 1: Оршил
\include{Chapters/Chapter2}   % БҮЛЭГ 2: Холбоотой бүтээлүүдийн судалгаа
\include{Chapters/Chapter3}   % БҮЛЭГ 3: Арга зүй ба архитектур
