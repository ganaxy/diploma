...
CKPT_DIR = os.path.join(WORK_DIR, "best_mnbert_v6_model")
BASE_CSV = os.path.join(WORK_DIR, "relabeled_normalized.csv")
OUT_CSV  = os.path.join(WORK_DIR, "mislabeled_rows_v6.csv")
...
print(f"Loaded relabeled base: {len(df)} rows "
...
print(f"✅ [Step 3.3 — v6 checkpoint loaded]")
...
print(f"\nOverall accuracy on relabeled base (all splits): {overall_acc:.4f}")
...
print("\n" + "═"*64)
print(" STEP 3 — MISLABELED ROWS REPORT (v6 checkpoint)")
print("═"*64)
