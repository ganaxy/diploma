...
OUT_CSV     = os.path.join(WORK_DIR, "mislabeled_rows.csv")
...
print("✅ [Step 3.2 — base data loaded]")
...
print(f"✅ [Step 3.3 — v1 checkpoint loaded]")
...
print(f"\nOverall accuracy on base (all splits): {overall_acc:.4f}")
...
print("\n" + "═"*64)
print(" STEP 3 — MISLABELED ROWS REPORT (v1 checkpoint)")
print("═"*64)
...
for sp in ("train", "val", "test"):
    ...
    rows.append((sp, sp_mis, sp_total, rate))
