...
CKPT_DIR = os.path.join(WORK_DIR, "best_mnbert_v9_model")
BASE_CSV = os.path.join(WORK_DIR, "relabeled_v9_normalized.csv")
OUT_CSV  = os.path.join(WORK_DIR, "mislabeled_rows_v9.csv")
...
print(f"Loaded v9 base: {len(df)} rows "
...
print(f"✅ [Step 3.3 — v9 checkpoint loaded]")
...
print(f"\nOverall accuracy on v9 base (all splits): {overall_acc:.4f}")
...
print("\n" + "═"*64)
print(" STEP 3 — MISLABELED ROWS REPORT (v9 checkpoint)")
print("═"*64)
